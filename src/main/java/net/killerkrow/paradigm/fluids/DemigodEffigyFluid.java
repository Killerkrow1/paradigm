...
public abstract class DemigodEffigyFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_DEMIGOD_EFFIGY;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_DEMIGOD_EFFIGY;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.DEMIGOD_EFFIGY_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.DEMIGOD_EFFIGY_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends DemigodEffigyFluid {
        @Override
    ...
    public static class Still extends DemigodEffigyFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
