...
public abstract class VoydEssenceFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_VOYD_ESSENCE;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_VOYD_ESSENCE;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.VOYD_ESSENCE_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.VOYD_ESSENCE_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends VoydEssenceFluid {
        @Override
    ...
    public static class Still extends VoydEssenceFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
