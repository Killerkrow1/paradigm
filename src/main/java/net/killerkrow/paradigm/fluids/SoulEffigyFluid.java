...
public abstract class SoulEffigyFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_SOUL_EFFIGY;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_SOUL_EFFIGY;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.SOUL_EFFIGY_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.SOUL_EFFIGY_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends SoulEffigyFluid {
        @Override
    ...
    public static class Still extends SoulEffigyFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
