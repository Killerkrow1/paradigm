...
public abstract class GodEffigyFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_GOD_EFFIGY;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_GOD_EFFIGY;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.GOD_EFFIGY_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.GOD_EFFIGY_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends GodEffigyFluid {
        @Override
    ...
    public static class Still extends GodEffigyFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
