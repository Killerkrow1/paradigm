...
public abstract class SemigodEffigyFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_SEMIGOD_EFFIGY;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_SEMIGOD_EFFIGY;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.SEMIGOD_EFFIGY_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.SEMIGOD_EFFIGY_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends SemigodEffigyFluid {
        @Override
    ...
    public static class Still extends SemigodEffigyFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
