...
public abstract class JadeEffigyFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_JADE_EFFIGY;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_JADE_EFFIGY;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.JADE_EFFIGY_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.JADE_EFFIGY_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends JadeEffigyFluid {
        @Override
    ...
    public static class Still extends JadeEffigyFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
