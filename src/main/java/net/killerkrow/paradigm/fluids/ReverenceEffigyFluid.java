...
public abstract class ReverenceEffigyFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_REVERENCE_EFFIGY;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_REVERENCE_EFFIGY;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.REVERENCE_EFFIGY_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.REVERENCE_EFFIGY_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends ReverenceEffigyFluid {
        @Override
    ...
    public static class Still extends ReverenceEffigyFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
