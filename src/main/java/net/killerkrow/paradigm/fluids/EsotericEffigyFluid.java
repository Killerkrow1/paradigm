...
public abstract class EsotericEffigyFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_ESOTERIC_EFFIGY;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_ESOTERIC_EFFIGY;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.ESOTERIC_EFFIGY_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.ESOTERIC_EFFIGY_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends EsotericEffigyFluid {
        @Override
    ...
    public static class Still extends EsotericEffigyFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
