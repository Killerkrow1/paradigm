...
public abstract class SolarEffigyFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_SOLAR_EFFIGY;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_SOLAR_EFFIGY;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.SOLAR_EFFIGY_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.SOLAR_EFFIGY_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends SolarEffigyFluid {
        @Override
    ...
    public static class Still extends SolarEffigyFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
