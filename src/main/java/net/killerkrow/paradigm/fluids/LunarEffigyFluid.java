...
public abstract class LunarEffigyFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_LUNAR_EFFIGY;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_LUNAR_EFFIGY;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.LUNAR_EFFIGY_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.LUNAR_EFFIGY_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends LunarEffigyFluid {
        @Override
    ...
    public static class Still extends LunarEffigyFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
