...
public abstract class DeadWaterFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_DEAD_WATER;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_DEAD_WATER;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.DEAD_WATER_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.DEAD_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends DeadWaterFluid {
        @Override
    ...
    public static class Still extends DeadWaterFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
