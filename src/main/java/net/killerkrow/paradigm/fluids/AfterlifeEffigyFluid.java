...
public abstract class AfterlifeEffigyFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_AFTERLIFE_EFFIGY;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_AFTERLIFE_EFFIGY;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.AFTERLIFE_EFFIGY_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.AFTERLIFE_EFFIGY_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends AfterlifeEffigyFluid {
        @Override
    ...
    public static class Still extends AfterlifeEffigyFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
