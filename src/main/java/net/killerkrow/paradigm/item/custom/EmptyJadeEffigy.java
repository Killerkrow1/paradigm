...
public class EmptyJadeEffigy extends TrinketItem {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.paradigm.emptyjadeeffigy.tooltip"));
    ...
    private ItemStack getTransformedItem(BlockState state) {
        ...
        if (state.isOf(Blocks.EMERALD_BLOCK)) {
            ...
            return new ItemStack(ModItems.CHARGED_EMPTY_JADE_EFFIGY);
        }
