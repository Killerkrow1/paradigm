...
public class TestItem extends Item {
    ...
    private static final int REQUIRED_COUNT = REQUIRED_BLOCKS.length + 18;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        for (int i = 19; i < absorbedList.size(); i++) {
        ...
        if (!alreadyAbsorbed) {
            ...
            if (absorbedList.size() >= REQUIRED_COUNT) {
                ItemStack transformedStack = new ItemStack(net.minecraft.item.Items.DIAMOND);
