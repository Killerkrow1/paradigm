...
public class CrusherDiamond extends MiningToolItem {
    public CrusherDiamond(ToolMaterial material, int attackDamage, float attackSpeed, Item.Settings settings) {
