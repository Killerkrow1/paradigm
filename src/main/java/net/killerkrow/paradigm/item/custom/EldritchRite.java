...
public class EldritchRite extends Item{
    public EldritchRite(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (Screen.hasShiftDown()) {
            tooltip.add(Text.translatable("tooltip.paradigm.eldritchrite.tooltip").formatted(Formatting.DARK_PURPLE));
        } else {
