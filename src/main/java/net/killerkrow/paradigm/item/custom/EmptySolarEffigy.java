...
public class EmptySolarEffigy extends Item {
    ...
    public EmptySolarEffigy(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!alreadyAbsorbed) {
            ...
            if (absorbedList.size() >= REQUIRED_COUNT) {
                ItemStack transformedStack = new ItemStack(ModItems.CHARGED_EMPTY_SOLAR_EFFIGY);
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.literal("Ochre Froglights Absorbed: " + absorbedCount + " / " + REQUIRED_COUNT)
