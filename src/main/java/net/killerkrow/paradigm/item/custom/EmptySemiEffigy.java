...
public class EmptySemiEffigy extends TrinketItem {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.paradigm.emptysemieffigy.tooltip"));
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (state.isOf(Blocks.CONDUIT) || state.isOf(Blocks.NETHERITE_BLOCK) || state.isOf(Blocks.ENCHANTING_TABLE) //Semigod Effigy starter
    ...
    private ItemStack getTransformedItem(BlockState state) {
        ...
        if (state.isOf(Blocks.CONDUIT)) {
            ...
            return new ItemStack(ModItems.CHARGED_EMPTY_SEMI_EFFIGY);
        }
