...
public class ModFoodComponents {
    ...
    public static final FoodComponent COOKED_SCULK_RICE = new FoodComponent.Builder().alwaysEdible().hunger(7).saturationModifier(0.5f).build();
    public static final FoodComponent SCULK_ROLL = new FoodComponent.Builder().alwaysEdible().hunger(24).saturationModifier(0.25f).build();
    public static final FoodComponent SCULK_ROLL_SLICE = new FoodComponent.Builder().alwaysEdible().hunger(8).saturationModifier(0.75f).build();
    ...
    public static final FoodComponent SCULK_CHEESE = new FoodComponent.Builder().alwaysEdible().hunger(8).saturationModifier(0.5f).build();
    public static final FoodComponent SCULK_TEA = new FoodComponent.Builder().alwaysEdible().hunger(1).saturationModifier(1f).build();
    public static final FoodComponent SCULK_BREAD = new FoodComponent.Builder().alwaysEdible().hunger(5).saturationModifier(0.7f).build();
