...
public class ReverenceVines extends AbstractPlantStemBlock implements Fertilizable, RevCaveVines {
    private static final float GROW_CHANCE = 0.11F;

    public ReverenceVines(AbstractBlock.Settings settings) {
    ...
    protected Block getPlant() {
        return ModBlocks.REVERENCE_VINES_PLANT;
    }
