...
public class GildenClusterBlock extends AmethystBlock implements Waterloggable {
    ...
    public GildenClusterBlock(int height, int xzOffset, AbstractBlock.Settings settings) {
        super(settings);
